...
export const routes: RouteEntry[] = [
  ...
  { path: '/components/input',            label: 'Input',            category: 'component', status: 'ready', description: 'Input atom.',            load: () => import('../pages/components/SparcInput.mdx') },
