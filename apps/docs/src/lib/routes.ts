...
export const routes: RouteEntry[] = [
  ...
  { path: '/components/combobox',           label: 'Combobox',           category: 'component', status: 'ready', description: 'Combobox component.',           load: () => import('../pages/components/SparcCombobox.mdx') },
  ...
  { path: '/components/dropdown',           label: 'Dropdown',           category: 'component', status: 'ready', description: 'Dropdown component.',           load: () => import('../pages/components/SparcDropdown.mdx') },
  ...
  { path: '/components/pagination',         label: 'Pagination',         category: 'component', status: 'ready', description: 'Pagination component.',         load: () => import('../pages/components/SparcPagination.mdx') },
  ...
  { path: '/components/text-field',         label: 'Text Field',         category: 'component', status: 'ready', description: 'Text field component.',       load: () => import('../pages/components/SparcTextField.mdx') },
  { path: '/components/timeline',           label: 'Timeline',           category: 'component', status: 'ready', description: 'Timeline component.',           load: () => import('../pages/components/SparcTimeline.mdx') },
