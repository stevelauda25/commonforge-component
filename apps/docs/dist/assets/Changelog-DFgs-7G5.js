import{u as r,j as n}from"./index-k1lh-pZG.js";function s(o){const e={blockquote:"blockquote",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",ul:"ul",...r(),...o.components},{PageHeader:t}=e;return t||i("PageHeader"),n.jsxs(n.Fragment,{children:[n.jsx(t,{title:"Changelog",description:"Notable changes to this design system. `cf-ui` and `cf-tokens` are local workspace packages and ship in lockstep."}),`
