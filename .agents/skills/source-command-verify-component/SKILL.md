---
name: "source-command-verify-component"
...
# source-command-verify-component

Use this skill when the user asks to run the migrated source command `verify-component`.
