...
import { ProgressValueBar } from "../progress-value-bar"
const { REAL_SKILLS }: { REAL_SKILLS: { kpis: any[], trade: any[], professional: any[] } } = { REAL_SKILLS: { kpis: [], trade: [], professional: [] } } as any;
...
const KPIS = REAL_SKILLS.kpis.length > 0 ? (REAL_SKILLS.kpis as typeof KPIS_SAMPLE) : KPIS_SAMPLE
...
const TRADE = REAL_SKILLS.trade.length > 0 ? (REAL_SKILLS.trade as typeof TRADE_SAMPLE) : TRADE_SAMPLE
const PROFESSIONAL = REAL_SKILLS.professional.length > 0 ? (REAL_SKILLS.professional as typeof PROFESSIONAL_SAMPLE) : PROFESSIONAL_SAMPLE
