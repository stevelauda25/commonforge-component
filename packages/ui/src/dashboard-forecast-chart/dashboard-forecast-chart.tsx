...
const { REAL_FORECAST }: { REAL_FORECAST: Record<string, number[]> } = { REAL_FORECAST: {} } as any;
...
function pointOnSmoothPath(points: readonly (readonly [number, number])[], x: number) {
  if (points.length < 2) return [0, 0] as const
              ...
              {graphOpen && (
                ...
                >
                  ...
                  <ListBase
                    ...
                    leading={<Checkbox checked={allSeriesSelected} tabIndex={-1} className="pointer-events-none" />}
