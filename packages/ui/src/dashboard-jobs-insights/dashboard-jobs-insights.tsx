...
const { REAL_NEEDS_JOBS, REAL_PROJECTED_JOBS }: { REAL_NEEDS_JOBS: any[], REAL_PROJECTED_JOBS: any[] } = { REAL_NEEDS_JOBS: [], REAL_PROJECTED_JOBS: [] };
...
const NEEDS_JOBS = REAL_NEEDS_JOBS.length > 0 ? (REAL_NEEDS_JOBS as typeof NEEDS_JOBS_SAMPLE) : NEEDS_JOBS_SAMPLE
...
const PROJECTED_JOBS = REAL_PROJECTED_JOBS.length > 0 ? (REAL_PROJECTED_JOBS as typeof PROJECTED_JOBS_SAMPLE) : PROJECTED_JOBS_SAMPLE
...
const PROJECTED_FILTERS = [
  { id: "all", label: "All jobs", matches: () => true },
  {
    id: "over",
