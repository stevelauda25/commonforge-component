...
import { ProgressBarBase, type ProgressBarBaseSize } from "../progress-bar-base/index.js"
    ...
    return (
      <div className={cn("w-full", className)} {...props}>
        ...
        >
          ...
          <span className={cn("shrink-0", valueClassName)}>{valueFormatter(value, max)}</span>
        </div>
        <ProgressBarBase
          aria-label={label}
          percent={percent}
